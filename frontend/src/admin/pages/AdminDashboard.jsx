        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span
                className={`flex items-center text-xs font-bold px-2 py-1 rounded-full ${stat.isPositive ? "bg-green-50 text-green-600" : "bg-red-50 text-red-600"}`}
              >
                {stat.isPositive ? (
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                {recentBookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-bold ${getStatusStyle(booking.status)}`}
                      >
                        {booking.status}
                      </span>
                    </td>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              recentUsers.map((user) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <span
                      className={`text-xs font-semibold px-2 py-0.5 rounded ${user.role === "Vendor" ? "bg-purple-50 text-purple-600" : "bg-blue-50 text-blue-600"}`}
                    >
                      {user.role}
                    </span>
          ...
          <div className="p-4 text-center">
            <Link
              to="/admin/users"
              className="block w-full py-2 text-sm text-gray-600 font-medium hover:bg-gray-50 rounded-lg transition-colors border border-dashed border-gray-300 no-underline"
            >
              Manage Users
            </Link>
          </div>
