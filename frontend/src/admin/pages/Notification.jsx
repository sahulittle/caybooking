...
const Notification = () => {
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'System Maintenance', message: 'Scheduled maintenance on Sunday 2 AM.', recipient: 'Everyone', type: 'Broadcast', date: '2023-10-25 10:30 AM' },
    { id: 2, title: 'Policy Update', message: 'Please review the updated vendor terms.', recipient: 'Vendors', type: 'Group', date: '2023-10-24 02:15 PM' },
    { id: 3, title: 'Holiday Discount', message: 'Get 10% off on all services this weekend!', recipient: 'Users', type: 'Group', date: '2023-10-22 09:00 AM' },
  ])
  ...
  const handleSend = (e) => {
    ...
    const newNotification = {
      ...
      recipient: getRecipientLabel(formData.recipientType, formData.specificId),
      type: formData.recipientType === 'all' ? 'Broadcast' : 'Targeted',
                  ...
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-400 flex items-center gap-1">
                        To: <span className="font-medium text-gray-600">{notification.recipient}</span>
                      </span>
                    </div>
