              ...
              {!loading && filteredVendors.length > 0 ? (
                filteredVendors.map((vendor) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusStyle(vendor.status)}`}
                      >
                        {vendor.status}
                      </span>
                    </td>
            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 text-center md:text-left">
                  ...
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mb-4 ${getStatusStyle(selectedVendor.status)}`}
                  >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div>
                        <p className="text-sm text-gray-600">
                          Current Status:
                          <span
                            className={`ml-2 font-bold px-2 py-0.5 rounded-full text-xs ${getKycStatusStyle(selectedVendor.isVerified ? "Verified" : "Pending")}`}
                          >
                        ...
                        <a
                          href="#"
                          className="text-blue-600 text-sm font-semibold hover:underline flex items-center gap-1 mt-1"
                        >
