...
const Sidebar = ({ isSidebarOpen }) => {
  const navItems = [
    ...
    { name: 'Service', icon: <DollarSign size={20} />, path: '/admin/services' },
    ...
    { name: 'Notification', icon: <MessageCircle size={20} />, path: '/admin/notification' },
    { name: 'Admin Role', icon: <AlertCircle size={20} />, path: '/admin/adminrole' }, 
