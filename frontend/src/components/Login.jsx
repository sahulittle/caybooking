      ...
      <div className="flex flex-col md:flex-row w-full max-w-[1200px] min-h-[750px] bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="hidden md:flex flex-1 bg-gradient-to-br from-indigo-600 to-purple-700 text-white flex-col justify-center p-12 items-center relative">
          ...
          <div className="relative z-10 text-center max-w-md">
            {/* Cayman Logo */}
            <img src={logo} alt="CayBookMe Logo" className="h-20 mx-auto mb-8 drop-shadow-xl" />
        ...
        <div className="flex-1 flex flex-col p-8 md:p-12 overflow-y-auto">
          ...
          <div className="flex justify-end mb-10">
            <div className="bg-gray-100 p-1 rounded-xl flex gap-1">
              <button className="px-6 py-2 text-sm font-bold bg-white text-indigo-600 rounded-lg shadow-sm">Login</button>
              <Link to="/signup" className="px-6 py-2 text-sm font-bold text-gray-500 hover:text-gray-800 transition-all">Signup</Link>
            </div>
          </div>

          <div className="w-full max-w-[420px] mx-auto">
            <h2 className="text-3xl font-black text-gray-900 mb-2">Welcome Back!</h2>
            <p className="text-gray-500 mb-8 font-medium">Please enter your details to log in.</p>
            ...
            <div className="relative mb-8 text-center">
              <span className="bg-white px-4 text-gray-400 text-xs font-bold uppercase relative z-10">or log in with email</span>
            ...
            <p className="text-center mt-8 text-gray-500 text-sm font-medium">
              ...
              <Link to="/signup" className="text-indigo-600 font-black hover:underline ml-1">Sign up</Link>
            </p>
